...
{
    public class ControleDeAcessoHub : Hub
    {
        private readonly IServiceWrapper _service;
        public ControleDeAcessoHub(IServiceWrapper service)
        {
            _service = service;
        }
        ...
        public override Task OnConnectedAsync()
        {
            ...
            _service.ConnectionSignalR.IncluirAlterar(objSave, EnumHubs.ControleDeAcesso);
        ...
        {
            _service.ConnectionSignalR.Remover(Context.ConnectionId, EnumHubs.ControleDeAcesso);
