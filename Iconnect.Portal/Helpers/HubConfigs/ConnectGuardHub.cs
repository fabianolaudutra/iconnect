...
{
    public class ConnectGuardHub : Hub
    {
        private readonly IServiceWrapper _service;
        public ConnectGuardHub(IServiceWrapper service)
        {
            _service = service;
        }
        ...
        public override Task OnConnectedAsync()
        {
            ...
            _service.ConnectionSignalR.IncluirAlterar(objSave, EnumHubs.Monitoramento);
        ...
        {
            _service.ConnectionSignalR.Remover(Context.ConnectionId, EnumHubs.Monitoramento);
