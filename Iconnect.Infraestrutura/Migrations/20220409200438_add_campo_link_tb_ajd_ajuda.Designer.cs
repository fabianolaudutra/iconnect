...
namespace Iconnect.Infraestrutura.Migrations
{
    ...
    [Migration("20220409200438_add_campo_link_tb_ajd_ajuda")]
    partial class add_campo_link_tb_ajd_ajuda
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_ajd_ajuda", b =>
                {
                    b.Property<int>("ajd_n_codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("ajd_c_descricao")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ajd_c_duvida")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ajd_c_link")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ajd_c_unique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");

                    b.Property<int>("ajd_cli_n_codigo")
                        .HasColumnType("int");

                    b.Property<DateTime?>("ajd_d_atualizado")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("ajd_d_inclusao")
                        .HasColumnType("datetime2");

                    b.Property<int>("ajd_tpc_n_codigo")
                        .HasColumnType("int");

                    b.HasKey("ajd_n_codigo");

                    b.HasIndex("ajd_cli_n_codigo");

                    b.HasIndex("ajd_tpc_n_codigo");

                    b.ToTable("tb_ajd_ajuda");
                });
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_cal_catalogo", b =>
                {
                    ...
                    b.Property<int?>("cal_logo_n_codigo")
                        .HasColumnType("int");

                    b.Property<int?>("cal_n_especialista")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("cal_logo_n_codigo")
                        .IsUnique()
                        .HasFilter("[cal_logo_n_codigo] IS NOT NULL");

                    b.HasIndex("cal_n_especialista");
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_cli_cliente", b =>
                {
                    ...
                    b.Property<int?>("cli_fot_fachada_n_codigo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("cli_fot_fachada_n_codigo");
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_mor_Morador", b =>
                {
                    ...
                    b.Property<int?>("mor_fro_n_codigo")
                        .HasColumnType("int");

                    b.Property<int?>("mor_grf_n_codigo")
                        .HasColumnType("int");

                    b.Property<int?>("mor_vec_n_codigo")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("mor_fro_n_codigo");

                    b.HasIndex("mor_grf_n_codigo");

                    b.HasIndex("mor_vec_n_codigo");
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_ocp_ocorrenciasOperador", b =>
                {
                    b.Property<int>("ocp_n_codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<DateTime>("ocp_c_data")
                        .HasColumnType("datetime2");

                    b.Property<string>("ocp_c_descricao")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ocp_c_status")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("ocp_c_unique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");

                    b.Property<int>("ocp_cli_n_codigo")
                        .HasColumnType("int");

                    b.Property<DateTime>("ocp_d_atualizado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValueSql("(getdate())");

                    b.Property<DateTime>("ocp_d_inclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValueSql("(getdate())");

                    b.Property<int>("ocp_ope_n_cadastrou")
                        .HasColumnType("int");

                    b.Property<int?>("ocp_ope_n_modificou")
                        .HasColumnType("int");

                    b.HasKey("ocp_n_codigo");

                    b.HasIndex("ocp_cli_n_codigo");

                    b.HasIndex("ocp_ope_n_cadastrou");

                    b.HasIndex("ocp_ope_n_modificou");

                    b.ToTable("tb_ocp_ocorrenciasOperador");
                });
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_sca_salaComercialCatalogo", b =>
                {
                    b.Property<int>("sca_n_codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<Guid>("sca_c_unique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");

                    b.Property<int>("sca_cal_n_codigo")
                        .HasColumnType("int");

                    b.Property<DateTime>("sca_d_atualizado")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValueSql("(getdate())");

                    b.Property<DateTime>("sca_d_inclusao")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime")
                        .HasDefaultValueSql("(getdate())");

                    b.Property<int>("sca_grf_n_codigo")
                        .HasColumnType("int");

                    b.HasKey("sca_n_codigo");

                    b.HasIndex("sca_cal_n_codigo");

                    b.HasIndex("sca_grf_n_codigo");

                    b.ToTable("tb_sca_salaComercialCatalogo");
                });
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_tpc_topicos", b =>
                {
                    b.Property<int>("tpc_n_codigo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);

                    b.Property<string>("tpc_c_descricao")
                        .HasColumnType("nvarchar(max)");

                    b.Property<Guid>("tpc_c_unique")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValueSql("(newid())");

                    b.Property<DateTime>("tpc_d_atualizado")
                        .HasColumnType("datetime2");

                    b.Property<DateTime>("tpc_d_inclusao")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("tpc_d_modificacao")
                        .HasColumnType("datetime2");

                    b.HasKey("tpc_n_codigo");

                    b.ToTable("tb_tpc_topicos");
                });
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_ajd_ajuda", b =>
                {
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_cli_cliente", "ajd_cli_n_codigoNavigation")
                        .WithMany("tb_ajd_ajuda")
                        .HasForeignKey("ajd_cli_n_codigo")
                        .HasConstraintName("FK_tb_ajd_ajuda_tb_cli_cliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Iconnect.Infraestrutura.Models.tb_tpc_topicos", "ajd_tpc_n_codigoNavigation")
                        .WithMany("tb_ajd_ajuda")
                        .HasForeignKey("ajd_tpc_n_codigo")
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_cal_catalogo", b =>
                {
                    ...
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_fot_foto", "cal_logo_n_codigoNavigation")
                        .WithOne("tb_cal_catalogoLogo")
                        .HasForeignKey("Iconnect.Infraestrutura.Models.tb_cal_catalogo", "cal_logo_n_codigo")
                        .HasConstraintName("FK_tb_cal_catalogoLogo_tb_fot_foto");

                    b.HasOne("Iconnect.Infraestrutura.Models.tb_mor_Morador", "cal_n_especialistaNavigation")
                        .WithMany("tb_cal_catalogo")
                        .HasForeignKey("cal_n_especialista")
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_cli_cliente", b =>
                {
                    ...
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_fot_foto", "cli_fot_fachada_n_codigoNavigation")
                        .WithMany("tb_cli_cliente")
                        .HasForeignKey("cli_fot_fachada_n_codigo")
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_mor_Morador", b =>
                {
                    ...
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_fro_frota", "mor_fro_n_codigoNavigation")
                        .WithMany("tb_mor_Morador")
                        .HasForeignKey("mor_fro_n_codigo")
                    ...
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_vec_veiculo", "mor_vec_n_codigoNavigation")
                        .WithMany("tb_mor_Morador")
                        .HasForeignKey("mor_vec_n_codigo")
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_ocp_ocorrenciasOperador", b =>
                {
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_cli_cliente", "ocp_cli_n_codigoNavigation")
                        .WithMany("tb_ocp_ocorrenciasOperador")
                        .HasForeignKey("ocp_cli_n_codigo")
                        .HasConstraintName("FK_tb_ocp_ocorrenciasOperador_tb_cli_cliente")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Iconnect.Infraestrutura.Models.tb_ope_operador", "ocp_ope_n_cadastrouNavigation")
                        .WithMany("tb_ocp_ocorrenciasOperadorCadastrou")
                        .HasForeignKey("ocp_ope_n_cadastrou")
                        .HasConstraintName("FK_tb_ocp_ocorrenciasOperador_tb_ope_operadorCadastrou");

                    b.HasOne("Iconnect.Infraestrutura.Models.tb_ope_operador", "ocp_ope_n_modificouNavigation")
                        .WithMany("tb_ocp_ocorrenciasOperadorModificou")
                        .HasForeignKey("ocp_ope_n_modificou")
            ...
            modelBuilder.Entity("Iconnect.Infraestrutura.Models.tb_sca_salaComercialCatalogo", b =>
                {
                    b.HasOne("Iconnect.Infraestrutura.Models.tb_cal_catalogo", "cal_n_codigoNavigation")
                        .WithMany("tb_sca_salaComercialCatalogo")
                        .HasForeignKey("sca_cal_n_codigo")
                        .HasConstraintName("FK_tb_sca_salaComercialCatalogo_tb_cal_catalogo")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Iconnect.Infraestrutura.Models.tb_grf_grupoFamiliar", "grf_n_codigoNavigation")
                        .WithMany("tb_sca_salaComercialCatalogo")
                        .HasForeignKey("sca_grf_n_codigo")
