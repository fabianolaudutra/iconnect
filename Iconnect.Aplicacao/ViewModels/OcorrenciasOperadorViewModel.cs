...
{
    public class OcorrenciasOperadorViewModel
    {
        ...
        public string ocp_cli_c_nomeFantasia { get; set; }
        public string ocp_ope_c_nomeCadastrou { get; set; }
        public string ocp_ope_c_nomeModificou { get; set; }
