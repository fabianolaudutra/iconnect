...
<html>
    ...
    <head><link rel="alternate" type="text/xml" href="/Consulta.asmx?disco" />
  ...
  <body>
    ...
    <div id="content">
      ...
      <p class="heading1">Consulta</p><br>

      

      <span>

          <p class="intro">The following operations are supported.  For a formal definition, please review the <a href="Consulta.asmx?WSDL">Service Description</a>. </p>
          
          
              <ul>
            
              <li>
                <a href="Consulta.asmx?op=ConsultaCEP">ConsultaCEP</a>
              ...
              <li>
                <a href="Consulta.asmx?op=HelloWorld">HelloWorld</a>
